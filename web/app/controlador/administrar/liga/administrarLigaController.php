...
class administrarLigaController {
    ...
    private function validar() {
        ...
        if ($data['pais_id'] === "" || !is_numeric($data['pais_id'])) {            
            $this->validateMessage = "Debe seleccionar un Pais de la liga, si no existe, diríjase al panel de Administración de paises y cree el apropiado";
            return false;
        }
        return true;
    }
